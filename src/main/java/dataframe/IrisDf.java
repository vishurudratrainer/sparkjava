...
public class IrisDf {
    ...
    public static void main(String[] args) {
        ...
        irisDf.show(5);
        System.out.println("New column based on condition");
        irisDf = irisDf.withColumn("Sepal_length_category",
                when(col("SepalLengthCm").lt(4.0), lit("Short"))
                        .when(col("SepalLengthCm").geq("4.1")
                                .and(col("SepalLengthCm").lt(6.0)), lit("Medium"))
                        .otherwise(lit("Long")));
        irisDf.show();
